...
export function LandingPage() {
  return (
    <div className="grid min-h-[calc(100vh-140px)] place-items-start pt-2 sm:place-items-center sm:pt-0">
      ...
      >
        <h1 className="mx-auto m-0 max-w-[18ch] text-[clamp(1.95rem,8.8vw,3.8rem)] leading-[1.08] tracking-[-0.03em]">
          Turn store visitors into paying customers
        </h1>
        <p className="mx-auto mt-5 max-w-[66ch] text-base leading-relaxed text-[#4b5563] sm:mt-6 sm:text-lg">
          HelpfulChat adds live and AI-powered sales chat to your Shopify, Wix, or WordPress store,
          helping you close sales and capture more leads 24/7.
        </p>
