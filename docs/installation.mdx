...
```
  ...
  <Step title="Connect widget to agent">
    The `url` prop should point to the chat endpoint that powers your agent. We'll cover how to create an agent and expose a streaming endpoint in the next section.
  </Step>
</Steps>
